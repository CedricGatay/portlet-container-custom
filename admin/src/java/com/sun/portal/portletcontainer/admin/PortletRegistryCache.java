...
public class PortletRegistryCache {
    ...
    private static Logger logger = Logger.getLogger(PortletRegistryCache.class.getPackage().getName(),
            "PALogMessages");
    ...
    private static void updatePortletRegistryCacheMonitor(String fileName) {
        ...
        try {
            ...
            if(logger.isLoggable(Level.INFO)) {
                ...
                logRecord.setParameters(new String[] { getMonitoredFileName(fileName)});
    ...
    /**
     * Returns the monitored config file name.
     * The monitored file name is same as the file name with "." prepended.
     */
