 ...
 */
public interface PortletRegistryElement extends Comparable {
     ...
     */
    public void setCollectionProperty(String key, List values) throws PortletRegistryException;
     ...
     */
    public void setCollectionProperty(String key, Map values) throws PortletRegistryException;
    
    /**
     * Returns the values contained in the Collection tag specified by the key.
     * The Collection tag contains String tags. This String tag has either "name" attribute
     * or both "name" and "value" attribute.
     * If the String tag has only "name" attribute, the Map returned contains the
     * value of the "name" attribute as both key and value.
     * If the String tag has both "name" and "value" attribute, the Map returned contains the
     * value of the "name" attribute as key and value of the "value" attribute as value.
     *
     ...
     */
    public void setStringProperty(String key, String value) throws PortletRegistryException;
    ...
    /**
     * Returns the all the properties, that corresponds to the content specified by "Properties" tag.
     *
     * @return a <code>String</code>, that corresponds to the content specified by "Properties" tag.
     */
