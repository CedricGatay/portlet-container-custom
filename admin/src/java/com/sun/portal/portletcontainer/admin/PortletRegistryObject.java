 ...
 * either PortletAppRegistry, PortletWindowRegistry or PortletWindowPreferenceRegistry.
 */
public interface PortletRegistryObject {
     ...
     */
    public boolean removeRegistryElement(PortletRegistryElement portletRegistryElement);

    /**
     * Returns the portlet registry element for the specified name. This can be
     * either be PortletAppRegistry, PortletWindowRegistry 
     * or PortletWindowPreferenceRegistry objects.
     *
