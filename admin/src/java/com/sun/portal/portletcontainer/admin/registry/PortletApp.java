...
public class PortletApp extends AbstractPortletRegistryElement {
    ...
    protected void populateValues(Element portletAppTag) {
        ...
        Map portletAppAttributes = XMLDocumentHelper.createAttributeTable(portletAppTag);
    ...
    protected void populateValues(PortletAppRegistryModel portletAppRegistryModel) {

		setName(portletAppRegistryModel.getName());
        setPortletName(portletAppRegistryModel.getPortletName());
        super.populateValues(portletAppRegistryModel.getProperties());
    }
    ...
    protected void create(Document document, Element rootTag) {
        ...
        Element portletAppTag = XMLDocumentHelper.createElement(document, PORTLET_APP_TAG);
	...
	public int compareTo(Object portletApp) {
		return this.getName().compareTo(((PortletApp)portletApp).getName());
	}
}
