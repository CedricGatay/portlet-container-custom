...
/**
 * PortletAppRegistryContext provides information pertaining to the portlet app registry.
 * This includes information about portlets.
 */
public interface PortletAppRegistryContext {
    ...
    public String getTitle(String portletName, String desiredLocales) throws PortletRegistryException;
