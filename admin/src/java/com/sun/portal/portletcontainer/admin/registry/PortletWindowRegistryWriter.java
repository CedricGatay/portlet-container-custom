...
public class PortletWindowRegistryWriter extends PortletRegistryWriter { 
    ...
    public PortletWindowRegistryWriter(String registryLocation) {
    ...
    public void writeDocument(List<PortletRegistryElement> portletWindowElementList,
		...
		PortletRegistryObject portletWindowRegistry = null;
		if(append && PropertiesContext.persistToFile()) {
			...
			portletWindowRegistry = new PortletWindowRegistry();
		}
