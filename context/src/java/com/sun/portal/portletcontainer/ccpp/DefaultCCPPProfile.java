...
/**
 * The DefaultCCPPProfile provides a dummy implementation of the
 * CCPP Profile object.
 */
public class DefaultCCPPProfile implements Profile {
     ...
     * attribute returned is implementation specific.  In this case, the
     * attribute should instead be retrieved with
     * <code>getComponent(String).getAttribute(String)</code>.
     * <p>The object returned by this method, if not <code>null</code>, is an
     * element of the <code>Set</code> returned by
     * <code>getAttributes()</code>.  The following expression will return
     * <code>true</code>:
     * <code>name.equals(getAttribute(name).getName())</code>.</p>
     *
     * @param name the name of the attribute to retrieve
     * @return the attribute with the specified name, or <code>null</code> if
     *         no such attribute exists within this profile
     */
     ...
     * returned by <code>getComponents()</code>.  The following expression
     * will return <code>true</code>:
     * <code>localtype.equals(getComponent(localtype).getDescription().getLocalType())</code>.
     *
     * @param localtype the local type of the component to retrieve as
     * returned by <code>Component.getDescription().getLocalType()</code>
     * @return the component with the specified local type, or
     *         <code>null</code> if no such component exists within this
     *         profile
     */
