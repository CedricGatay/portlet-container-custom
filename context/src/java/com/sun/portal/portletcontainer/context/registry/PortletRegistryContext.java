...
public interface PortletRegistryContext {
	...
	/**
	 * Returns the map of mime type vs supported channel modes
	 * for the given portlet as specificed in portlet.xml.
	 *
	 * @param portletName the name of the portlet
	 *
	 * @return a <code>Map</code> of supported mime type vs channel modes
	 * 
