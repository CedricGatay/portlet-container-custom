...
/**
 * A <code>PortletAdminDataException</code> is thrown when there are errors related to the
 * portlet admin console like deployment of portlet, creation of portlet window.
 */
