...
public class PortletAdminDataFactory {
    ...
    public static PortletAdminData getPortletAdminData() throws PortletRegistryException {
        ...
        PortletRegistryContext portletRegistryContext = factory.getPortletRegistryContext();
