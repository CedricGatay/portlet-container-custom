...
/**
 * PublicRenderParameterPolicyImpl provides a concrete implementation of the PublicRenderParameterPolicy
 *
 */
public class PublicRenderParameterPolicyImpl implements PublicRenderParameterPolicy{
    ...
    public PublicRenderParameterPolicyImpl(PortletPolicyDescriptor portletPolicyDescriptor) {
        this.portletPolicyDescriptor = portletPolicyDescriptor;
    }

    public DistributionType getDistributionType() {
        if(this.portletPolicyDescriptor != null) {
            return this.portletPolicyDescriptor.getPublicRenderParameterPolicyDistribution();
        }
