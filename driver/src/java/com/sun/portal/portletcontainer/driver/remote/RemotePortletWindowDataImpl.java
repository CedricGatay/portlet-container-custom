...
/**
 * RemotePortletWindowDataImpl provides wsrp specific implementation of PortletWindowData interface
 */
public class RemotePortletWindowDataImpl extends PortletWindowDataImpl {
    
    static final long serialVersionUID = 4L; 
    public RemotePortletWindowDataImpl() {
    }
    ...
    public void init(HttpServletRequest request, PortletRegistryContext portletRegistryContext,
        ...
        if(user == null || 
			user.getName().equals(WindowInvokerConstants.AUTHLESS_USER_ID) ){
          setEdit(false);
        }else{
          setEdit(true);
        }
