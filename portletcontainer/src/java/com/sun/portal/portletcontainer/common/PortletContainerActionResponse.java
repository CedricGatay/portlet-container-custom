...
public class PortletContainerActionResponse extends PortletContainerResponse {
    ...
    private ExecuteActionResponse response;
	private ChannelMode channelMode;
	private ChannelState channelState;
    
    public PortletContainerActionResponse( ExecuteActionResponse response ) {
        super( response );
     ...
     *
     * @param renderParameters the render parameters map
     **/
