 ...
 * the ActionURL tag or the ResourceURL tag. It allows parameters to be associated with the URL.
 * 
...
public class ParamTag extends TagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        if (name != null && name.length() > 0) {
            ParamBaseTag paramBaseTag = (ParamBaseTag) findAncestorWithClass(this, ParamBaseTag.class);
            paramBaseTag.addParam(name, value);
        }
        return SKIP_BODY;
    }
